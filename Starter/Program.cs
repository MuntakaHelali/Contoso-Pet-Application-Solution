    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for(int i = 0; i < maxPets; i++){
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if(ourAnimals[i,2] == null || ourAnimals[i,2] == "" || ourAnimals[i,2] == "Age: ?"){
                        do{
                    ...
                    validEntry = false;
                    if(ourAnimals[i,4] == null || ourAnimals[i,4] == "" || ourAnimals[i,4] == "Physical description: "){
                        do{
        ...
        case "4":
            ...
            for(int i = 0; i < maxPets; i++){
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if(ourAnimals[i,3] == null || ourAnimals[i,3] == "" || ourAnimals[i,3] == "Nickname: "){
                        do{
                    ...
                    validEntry = false;
                    if(ourAnimals[i,5] == null || ourAnimals[i,5] == "" || ourAnimals[i,5] == "Personality: "){
                        do{
